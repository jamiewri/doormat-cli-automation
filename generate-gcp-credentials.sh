...
echo ""
echo "   If you have tecli installed, you can create the variable on a workspace with the following"
echo "   command."
echo ""
echo "     tecli variable create  \\"
echo "         --workspace-id <workspace-id> \\"
echo "         --category env \\"
echo "         --sensitive \\"
echo "         --key GOOGLE_APPLICATION_CREDENTIALS \\"
echo "         --value \"\$(cat ~/.credentials/gcp-$SERVICE_ACCOUNT_NAME-tfc.json)\""
echo ""
echo "   If the variable already exists in the workspace, run this command instead."
echo ""
echo "     tecli variable update-by-key  \\"
echo "         --workspace-id <workspace-id> \\"
echo "         --category env \\"
echo "         --sensitive \\"
echo "         --key GOOGLE_APPLICATION_CREDENTIALS \\"
